...
public class AA_Pruebas {
    ...
    public static void main(String[] args) {
        ...
        //int lado=2;
        System.out.println("El area de un cuadrado de lado=2 es: "+areaCuadrado(5));
        ...
        //Puedo anidar funciones.
        System.out.println("AreaCirculo"+areaCirculo(areaCuadrado(5)));
        
    }
    
    //Aquí iran las funciones
    
    //Funcion para calcular el área del cuadrado
